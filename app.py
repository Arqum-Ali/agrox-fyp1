# app.py - Updated with daily reminder route (for cron job trigger)
...
from daily_reminder_job import send_daily_reminders  # <-- Ye line add kar de (daily reminders import)
...
def create_app():
    ...
    # Ye new route add kar de (daily reminders ko trigger karegi)
